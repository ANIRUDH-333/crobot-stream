...
def send_message():
    ...
    # RabbitMQ setup
    url = "amqps://crobot:passiscrobot@b-f19df6ec-ed5f-4427-bff3-b81ee7fbc645.mq.ap-south-1.amazonaws.com:5671"  # Replace with your AMQPS URL
    params = pika.URLParameters(url)
    connection = pika.BlockingConnection(params)
    channel = connection.channel()  # start a channel
    channel.queue_declare(queue='keystoke')  # Replace with your queue name

    # Send message
    channel.basic_publish(exchange='',
                          routing_key='keystoke',  # Replace with your queue name
                          body=key_press)

    connection.close()

    return jsonify({'status': 'success', 'key': key_press})
